...
if __name__ == "__main__":
    em = EmployeeManager()
    em.add_employee(EmployeeCreate(emp_id=em.get_next_emp_id(),name="Nitin Koorse", manager_id=None))
    em.add_employee(EmployeeCreate(emp_id=em.get_next_emp_id(),name="Arun Hegde", manager_id="E001"))
